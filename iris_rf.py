...
mlflow.set_experiment("iris-rf")  # Set the MLflow experiment
with mlflow.start_run(run_name="secondrf-run"):
  ...
  #  mlflow.sklearn.log_model(rf, "model")  # Log the trained model  
    ...
    mlflow.sklearn.log_model(model, "randomforest_model", input_example=input_example)
